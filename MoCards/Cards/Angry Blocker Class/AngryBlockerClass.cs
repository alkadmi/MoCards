...
namespace MoCards.Cards
{
    ...
    {
        internal static string name = "AngryBlocker";
        public override IEnumerator Init()
        {
            while (!(AngryBlocker.card && Crusher.card && EmpowerAdd.card && FrostSlamAdd.card && GetCloser.card && Holster.card &&
                ImplodeAdd.card && Ping.card && Quantum.card && Quasar.card && SawAdd.card && StaticFieldAdd.card && SupernovaAdd.card)) yield return null;
            {
